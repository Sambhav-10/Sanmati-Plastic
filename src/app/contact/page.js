      ...
      <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
          <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <p class="text-base font-semibold uppercase tracking-wide text-[#C39D63] ">
              Contact
            </p>
        ...
        <div class="flex items-stretch justify-center">
          <div class="grid md:grid-cols-2">
                ...
                <li class="flex">
                  ...
                  <div class="ml-4 mb-4">
                    <h3 class="mb-2 text-lg font-medium leading-6 ">
                      Industrial Area Umaria -Dungaria is in Jabalpur
                    </h3>
            ...
            <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
              <h2 class="mb-4 text-2xl font-bold text-[#C39D63]">
